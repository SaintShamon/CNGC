...
<section class="inner_first_section down_content section">
            ...
            <div class="text_block">
                ...
                <div class="bottom_wrapper">
                    ...
                    <div class="bottom_row">
                        <div class="btn_block">
                            <?php if($leftButton): ?>
                            <a href="<?php echo $leftButton['url'] ?>"
                                class="button button--white"><?php echo $leftButton['title'] ?></a>
                            <?php endif; ?>
                            <?php if($rightButton): ?>
                            <a href="<?php echo $rightButton['url']; ?>"
                                class="button button--secondary"><?php echo $rightButton['title']; ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endif; ?>
    ...
    <div class="img_block" style="background: left center / cover no-repeat url('<?php echo $image; ?>');">
        ...
        <div class="main_block">
            ...
            <div class="become_sponsor_wrapper">
                ...
                <div class="sponsors_block">
                    ...
                    <div class="btn_block">
                        <a href="<?php echo $button['url']; ?>"
                            class="button button--white"><?php echo $button['title']; ?></a>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endwhile; ?>
                ...
                <div class="sponsors_block blue_block">
                    ...
                    <div class="btn_block">
                        <a href="<?php echo $last_card['file_to_download']['url'] ?>" target="_blank"
                ...
                <div class="col">
                    ...
                    <div class="btn_block">
                        ...
                        <a href="<?php echo $left_button['url']; ?>"
                            class="button button--secondary"><?php echo $left_button['title']; ?></a>
                        <?php endif; ?>
                        <a href="<?php echo $right_button['url']; ?>"
                            class="button"><?php echo $right_button['title']; ?></a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
