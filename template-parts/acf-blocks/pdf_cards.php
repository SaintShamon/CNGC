                ...
                <div class="reports_list">
                    <?php while(have_rows('cards')): the_row(); ?>
                        ...
                        <div class="report_block">
                            ...
                            <?php if($file): ?>
                                <div class="btn_block">
                                    <a href="<?php echo $file['url']; ?>" class="button button--secondary" target="_blank">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path class="color-blue" fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                fill="" />
                                            <path class="color" opacity="0.302" fill-rule="evenodd"
                                                clip-rule="evenodd" d="M14.1719 0V7.03449H20.9785L14.1719 0Z"
                                                fill="" />
                                            <path class="color"
